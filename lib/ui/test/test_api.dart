...
class TestPageState extends State<TestPage> {
  ...
  initRoom() async {
    ...
    trtcCloud.setLogCallback(TRTCLogCallback(onLog: (String msg, TRTCLogLevel level, String extInfo) {
    ...
    return ListView(
      children: [
        ...
        ApiCheckerButton(
          ...
          parameters: [
            Parameter(name: 'param', type: ParameterType.string, value: jsonEncode({'roomId': 155, 'userId': "345"})),
          ],
          callApi: (params) {
        ...
        ApiCheckerButton(
            ...
            parameters: [
              Parameter(
                name: 'quality',
                type: ParameterType.tEnum,
                value: TRTCAudioQuality.music,
              ),
            ],
            callApi: (params) {
        ...
        ApiCheckerButton(
            ...
            parameters: [
              Parameter(name: 'frame', type: ParameterType.tClass, value: TRTCAudioFrame(length: 3, data: Uint8List.fromList([123, 1231, 321]))),
            ],
            callApi: (params) {
    ...
    return ListView(
      children: [
        ...
        ApiCheckerButton(
            ...
            parameters: [],
            callApi: (params) {
              txAudioEffectManager.setMusicObserver(
                  1,
                  TXMusicPlayObserver(onStart: (int id, int errorCode) {
              ...
              txAudioEffectManager.startPlayMusic(AudioMusicParam(id: 1, path: musicPath));
            }),
        ApiCheckerButton(
        ...
        ApiCheckerButton(
            ...
            parameters: [],
            callApi: (params) {
              txAudioEffectManager.setPreloadObserver(TXMusicPreloadObserver(
        ...
        ApiCheckerButton(
            ...
            callApi: (params) {
              ...
              txAudioEffectManager.preloadMusic(AudioMusicParam(id: 1, path: musicPath));
            }),
        ApiCheckerButton(
  ...
  ListView _testTXDevice() {
    return ListView(children: [
      ...
      ApiCheckerButton(
          methodName: 'startMicDeviceTest',
          parameters: [Parameter(name: 'interval', type: ParameterType.int, value: 10), Parameter(name: 'playback', type: ParameterType.bool, value: false)],
          callApi: (params) {
  ...
  TRTCStreamMixingConfig _getTRTCStreamMixingConfig() {
    ...
    layout.rect = TRTCRect(left: 1, top: 2, right: 3, bottom: 4);
    layout.zOrder = 5555;
